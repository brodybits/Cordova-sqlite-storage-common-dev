  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': tx sql select value results test(s)', function() {
      ...
      if (isAndroid)
        ...
        it(suiteName + 'SELECT TYPEOF(101) INLINE [returns text in case of androidDatabaseImplementation: 2]', function(done) {
        ...
        it(suiteName + 'SELECT ABS(?) with [101] parameter argument', function(done) {
        ...
        it(suiteName + 'SELECT ? with [101] parameter argument', function(done) {
        ...
        it(suiteName + 'SELECT TYPEOF(?) with [1234567890123] parameter argument [returns text in case of androidDatabaseImplementation: 2]', function(done) {
        ...
        it(suiteName + 'SELECT ABS(?) with [1234567890123] parameter argument', function(done) {
        ...
        it(suiteName + 'SELECT ? with [1234567890123] parameter argument', function(done) {
