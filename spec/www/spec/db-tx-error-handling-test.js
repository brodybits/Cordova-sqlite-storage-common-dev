  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': detailed tx error handling test(s)', function() {
      ...
      describe(scenarioList[i] + ': other tx error handling test(s)', function() {
        ...
        it(suiteName + "db.transaction('') in try-catch block and then SELECT transaction [TBD Windows]", function (done) {
        ...
        it(suiteName + "db.readTransaction('') in try-catch block and then SELECT transaction [TBD Windows]", function (done) {
