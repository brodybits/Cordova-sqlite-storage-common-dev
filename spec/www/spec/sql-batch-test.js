  ...
  for (var i=0; i<pluginScenarioCount; ++i) {
    ...
    describe(pluginScenarioList[i] + ': BATCH SQL test(s)', function() {
      ...
      describe(pluginScenarioList[i] + ': Basic sql batch test(s)', function() {
        ...
        it(suiteName + 'Single-column batch sql test values: INSERT +/- Infinity & NaN values and check stored data [TBD Android/iOS plugin result for +/- Infinity]', function(done) {
