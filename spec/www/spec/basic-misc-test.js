    ...
    describe(scenarioList[i] + ': basic/misc. db tx/sql feature test(s)', function() {
      ...
      var openDatabase = function(name, ignored1, ignored2, ignored3) {
        ...
        it(suiteName + 'db readTransaction with a WITH clause', function(done) {
          ...
          if (isAndroid && isOldImpl) pending('SKIP [BROKEN] for android.database implementation'); // NOT WORKING with android.database implementation
        ...
        it(suiteName + 'create virtual table using R-Tree', function(done) {
          ...
          if (isWP8) pending('NOT IMPLEMENTED for WP(8)'); // NOT IMPLEMENTED in CSharp-SQLite
          if (isAndroid && isOldImpl) pending('NOT IMPLEMENTED for all versions of built-in android.database.sqlite implementation'); // NOT IMPLEMENTED for all versions of android.database.sqlite (failed in Circle CI)
