  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': db tx error mapping test(s)', function() {
      ...
      var openDatabase = function(name, ignored1, ignored2, ignored3) {
        ...
        //   Also missing actual error info (does include some info to indicate prepare vs execute)

        // OTHER ERROR MAPPING NOTES:
        //
        // - (WebKit) Web SQL apparently includes "prepare statement" vs "execute statement"
        //   stage info along with the sqlite error code
        // - Default Android implementation (Android-sqlite-connector) includes
        //   sqlite3_prepare_v2 vs sqlite3_step function call info which indicates
        //   "prepare statement" vs "execute statement"
