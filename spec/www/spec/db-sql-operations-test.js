  ...
  describe('Plugin: plugin-specific sql test(s)', function() {
    ...
    for (var i=0; i<pluginScenarioCount; ++i) {
      ...
      describe(pluginScenarioList[i] + ': db.executeSql test(s)', function() {
        ...
        it(suiteName + 'db.executeSql check SELECT TYPEOF(?) with [null] for parameter argument array [TBD Android/iOS/macOS plugin result]', function(done) {
        ...
        it(suiteName + 'db.executeSql check SELECT TYPEOF(?) with [undefined] for parameter argument array [TBD Android/iOS/macOS plugin result]', function(done) {
