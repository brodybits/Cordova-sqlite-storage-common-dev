...
- In case of ignored INSERT OR IGNORE statement this plugin reports an old INSERT row id value on iOS, macOS, and Windows. (WebKit Web SQL also reports an old INSERT row id value in case of an ignored INSERT OR IGNORE statement on Android and iOS.)
