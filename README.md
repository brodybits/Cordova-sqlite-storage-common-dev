...
- In certain cases such as `transaction.executeSql(null)` or `transaction.executeSql(null)` the plugin throws an exception while (WebKit) Web SQL indicates a transaction failure.
