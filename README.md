...
- In case of an error, the error `code` member is INVALID on Windows.
...
- UNICODE `\u0000` (same as `\0`) character is not supported and known to be broken for Android (default [Android-sqlite-connector](https://github.com/liteglue/Android-sqlite-connector) database implementation) and Windows
